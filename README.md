...
|-|----|---|-----
|1|Анализ бизнес-показателей в Яндекс.Афише|Изучено поведение пользователей сервиса и рассчитаны основные бизнес-показатели: DAU/WAU/MAU, Retention Rate, LTV, САС ROMI|pandas matplotlib seaborn numpy
